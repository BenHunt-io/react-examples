...
import FaucetSelect from './components/FaucetSelect';
import { NftProductCardModel } from './components/NftProductCard';

let products: NftProductCardModel[] = [
    {
        id: 1,
        name: "NFT Cyber Punk",
        price: 2,
        image: NftCyberPunk,
        meta: {
             title: "NFT Cyber Punk",
             royalty_percent: 10,
             resellable: true,
             edition_number: 1,
             edition_total: 5,
             tokenId: "badd8b97b946d6b4"
        }
    },
    {
        id: 2,
...
class CompositionVsInheritance extends React.Component<{}, { balance: number, assets: Array<string>, products: NftProductCardModel[], renderAlert: boolean }> {
    ...
    onFaucetReceive(withdrawalAmt: number, e: React.SyntheticEvent){
        this.setState(prevState => ({
            balance: prevState.balance + withdrawalAmt
        }))
    }
            ...
            <Layout>
                <div className="container">
                    ...
                    { this.state.balance <= 0 
                        ?<div className="row">
                                <div className="col">
                                    <FaucetSelect onFaucetReceive={this.onFaucetReceive}/>
                                </div>
                            </div>
